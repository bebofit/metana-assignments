...
describe("[Challenge] Free Rider", function () {
  ...
  before(async function () {
    ...
    // Deploy NFT contract
    nft = (await ethers.getContractFactory("DamnValuableNFT", deployer)).attach(
      await marketplace.token()
    );
  ...
  it("Execution", async function () {
    ...
    const FreeRider = await ethers.getContractFactory("FreeRiderAttack");
