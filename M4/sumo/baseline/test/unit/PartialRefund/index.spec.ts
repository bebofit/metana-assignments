...
export const runPartialFundTest = (): void => {
  ...
  describe(`#withdraw`, function () {
    ...
    it(`should not withdraw if not owner...`, async function () {
      ...
      ).to.be.revertedWithCustomError(this.partialRefund, `NotAuth`);
    });
  });
  ...
  describe("receive buy token", function () {
    it("should invoke the receive function and fail as no tokent provided", async function () {
